...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rubros.unidad_medida'
        db.add_column(u'empresas_rubros', 'unidad_medida',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rubros.unidad_medida'
        db.delete_column(u'empresas_rubros', 'unidad_medida')
    ...
    models = {
        ...
        u'empresas.rubros': {
            ...
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'unidad_medida': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
