...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promotor.innovador'
        db.add_column(u'promotores_promotor', 'innovador',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promotor.innovador'
        db.delete_column(u'promotores_promotor', 'innovador')
    ...
    models = {
        ...
        u'promotores.promotor': {
            ...
            'innovador': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
